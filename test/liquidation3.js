...
describe("LiquidationLiquidation test for question 3", function () {
  it("Test Liquidation WETH and USDC", async function () {
    console.log("\n-- Start Liquidation USDC --")
    ...
    const liquidationTx = await liquidationOperator.operate(debt_USDC_input,overrides = {gasPrice: gasPrice});
    ...
    console.log("-- Finish Liquidation USDC --")
  });
});